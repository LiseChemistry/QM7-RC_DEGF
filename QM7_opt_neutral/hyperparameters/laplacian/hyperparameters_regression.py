...
y = np.loadtxt(f"/home/student5/lise/MasterProject_SPAHM-ENN/QM7_opt_neutral/hirsh/{atom}_charges.txt")
...
hyperparameters_file = os.path.join(results_dir, f'myLfast_hyperparam_{atom}_{rep}_split_{seed}.txt')
...
regression_results_file = os.path.join(results_dir, f'myLfast_regression_{atom}_{rep}_split_{seed}.txt')
target_predicted_file = os.path.join(results_dir, f'myLfast_target_pred_{atom}_{rep}_split_{seed}.txt')
mae_file = os.path.join(results_dir, f'myLfast_MAE_{atom}_{rep}_split_{seed}.txt')
