...
outputfile = "Atomization_energies.txt"
ZPEfile = "ZPE.txt"
E0_file = "E_0.txt"
mol_list = "list_neutral.txt"
...
def calculate_x_energies(molname):
    mol_path = f"/home/student5/lise/MasterProject_SPAHM-ENN/QM7_opt_neutral/opt_neutral_xyz/xyz_opt_0_1/{molname}.xyz"

    if not os.path.exists(mol_path):
        print(f"File {mol_path} not found.")
        return 0.0

    mol = qs.compound.xyz_to_mol(mol_path, basis='Def2SVP', charge=0, spin=0, ignore=False, unit='ANG', ecp=None)
