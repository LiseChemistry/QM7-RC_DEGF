...
def compute_a_spahm(xyz_file, elements=["H", "C", "N", "O", "S"], charge=0, spin=0, dm=None, guess="LB", model="lowdin-long-x", only_z=None, open_mod=["alpha", "beta"]):
    ...
    X = atom.get_repr(mol, elements=["H", "C", "N", "O", "S"], charge=0, spin=0, dm=None, guess="LB", model="lowdin-long-x", only_z=None, open_mod=["alpha", "beta"])
...
def main():
    ...
    results_dir = os.path.join(path, '/home/student5/lise/MasterProject_SPAHM-ENN/QM7_opt_neutral/representations_0/a_spahm/results')
    ...
    if os.path.exists(xyz_path):
        X = compute_a_spahm(xyz_path, elements=["H", "C", "N", "O", "S"], charge=0, spin=0, dm=None, guess="LB", model="lowdin-long-x", only_z=None, open_mod=["alpha", "beta"])
    else:
